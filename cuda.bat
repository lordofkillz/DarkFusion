...
SET "OPENCVP=%DFPATH%"
SET "CUDAPATH=C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v11.6"
...
:: Call Python script to test CUDA
echo Running CUDA test script
python "C:\DarkFusion\cuda.py"
