...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def plot_histogram(self):
        ...
        plt.show()
    def plot_bar(self):
        """Generate a bar plot showing class distribution, including classes with zero count."""
        ...
        # Ensure all classes are represented, including those with zero counts
        counts = [class_counts.get(idx, 0) for idx in range(len(class_names))]
    ...
    def display_image(self, file_name=None, image=None):
        ...
        if image is not None:
            ...
            if file_name:
                ...
                if not has_labels:
                    logging.info("📭 No labels found. Displaying image without annotations.")

                    self.image = QPixmap.fromImage(image_qimage)

                    # Clear and rebuild scene with just the image
