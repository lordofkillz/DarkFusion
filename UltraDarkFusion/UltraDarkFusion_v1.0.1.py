...
os.environ['PATH'] = 'C:\\src\\darknet;' + os.environ['PATH']

os.environ['PATH'] = 'C:\\EAL\\Scripts\\TensorRT\\lib;' + os.environ['PATH']
...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def auto_label_images2(self):
        ...
        for idx, image_file in enumerate(self.image_files):
            ...
            try:
                if self.model_type == 'yolov5':
                    ...
                    # If a TensorRT engine is loaded, it will be used internally for inference
        ...
        # Finalize progress bar after all images have been processed
...
# for blanks
    ...
    def open_weights(self):
        ...
        file_name, _ = QFileDialog.getOpenFileName(
            None, "Open Weights/Model", "", "Weights/Model Files (*.weights *.pt *.engine)", options=options)
        ...
        if file_name:
            ...
            if file_name.endswith('.engine'):
                try:
                    self.model = YOLO(file_name)  # Load the TensorRT engine file
                    self.model_type = 'yolov8'
                    print("Loaded model as YOLOv8 with TensorRT.")
                    self.auto_label_images2()  # Call auto-labeling function after the model is loaded
                except Exception as e_engine:
                    print(f"Failed to load TensorRT engine file. Error: {e_engine}")
